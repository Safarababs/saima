    ...
    <div className="coursesPage">
        ...
        <div className="breadcrumb-container">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link href="/femaleteacher">Teachers</Link>
              </li>
      ...
      <div className="courseDisplay">
        ...
        <div className="courseContent">
          <h2>About Female Quran Teacher</h2>
          <p>
            At Al Mehdi Online Quran Academy, discover the foundational
            principles of the Quran with the guidance of our dedicated female
      ...
      <section className="courses">
        <h2>What will students learn from our Online Quran Teacher?</h2>
        ...
        <div className="coursescontainer">
          ...
          <p>
            These courses are designed in a way that students can learn and
            understand the Quran directly with live teachers. Choose the one
            that best suits you and your kids and get equipped with the learning
            of the Quran from professional and qualified Quran tutors.
          </p>
          <p>Build up a lifelong relationship with the Quran.</p>
      ...
      <div className="card">
        ...
        <p>
          At Al Mehdi Online Quran Academy, we proudly welcome students from
          across the globe, embracing diverse races and cultural backgrounds.
          Our dedicated Quran teachers have made a significant impact, helping a
          large number of students benefit from their expertise. Our online
          Quran teachers serve students in a wide range of countries, including
          the USA, Canada, Australia, the UK, Germany, Norway, Ireland,
          Switzerland, France, Italy, Iceland, Sweden, Denmark, Finland, Greece,
          Singapore, Hong Kong, Belgium, Spain, Oman, Qatar, Bahrain, Kuwait,
          Saudi Arabia, and the UAE. We are also continuously welcoming students
          from new regions around the world.
        </p>
        <p>
          We are confident that our team of professional and expert Quran
          teachers is the best choice for learning the Quran online. With their
          dedication and skill, you will receive high-quality instruction
          tailored to your needs, no matter where you are. Equip yourself with
          the knowledge and understanding of the Quran from our esteemed online
          teachers. Join Al Mehdi Online Quran Academy and experience
          exceptional Quranic education from anywhere in the world.
        </p>
      </div>
    </div>
  );
